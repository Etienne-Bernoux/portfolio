export const SKILLS = Object.freeze({
  ...
  edges: [
    ...
    { x1: 200, y1: 110, x2: 100, y2: 110, color: '#22d3ee', width: 1.5, delay: 'd1' },
    ...
    // Architecture (purple) — en V pour que les arêtes encadrent le label du hub
    { x1: 360, y1: 210, x2: 210, y2: 330, color: '#a78bfa', width: 1.5, delay: 'd0' },
    { x1: 210, y1: 330, x2: 100, y2: 400, color: '#a78bfa', width: 1.5, delay: 'd1' },
    { x1: 210, y1: 330, x2: 320, y2: 400, color: '#a78bfa', width: 1.5, delay: 'd1' },
    // AI & Agents (gold)
    { x1: 360, y1: 210, x2: 510, y2: 330, color: '#eab308', width: 1.5, delay: 'd0' },
    { x1: 510, y1: 330, x2: 400, y2: 400, color: '#eab308', width: 1.5, delay: 'd1' },
    { x1: 510, y1: 330, x2: 620, y2: 400, color: '#eab308', width: 1.5, delay: 'd1' },
    // Leadership (green)
  ...
  nodes: [
    ...
    // Architecture (purple)
    { name: 'Architecture', icon: '■', cx: 210, cy: 330, r: 18, color: '#a78bfa', strokeWidth: 2, delay: 'd1', label: 'Architecture', desc: { fr: 'Conception de systèmes distribués', en: 'Distributed systems design' } },
    { name: 'Design Patterns', icon: '◆', cx: 100, cy: 400, r: 15, color: '#a78bfa', strokeWidth: 1.5, delay: 'd2', label: 'Patterns', desc: { fr: 'SOLID, DDD, Clean Architecture', en: 'SOLID, DDD, Clean Architecture' }, iconSize: 11 },
    { name: 'Craftsmanship', icon: '✩', cx: 320, cy: 400, r: 15, color: '#a78bfa', strokeWidth: 1.5, delay: 'd2', label: 'Craftsmanship', desc: { fr: 'Clean code, refactoring, cause racine', en: 'Clean code, refactoring, root causes' }, iconSize: 11 },
    // AI & Agents (gold)
    { name: 'AI & Agents', icon: '◈', cx: 510, cy: 330, r: 18, color: '#eab308', strokeWidth: 2, delay: 'd1', label: 'AI & Agents', desc: { fr: 'Concevoir avec des agents, pas seulement les utiliser', en: 'Designing with agents, not just using them' } },
    { name: 'Compound engineering', icon: '∞', cx: 400, cy: 400, r: 15, color: '#eab308', strokeWidth: 1.5, delay: 'd2', label: 'Compound', desc: { fr: 'Chaque session laisse une trace réutilisable : learnings, plans, mémoire', en: 'Every session leaves something reusable: learnings, plans, memory' }, iconSize: 11 },
    { name: 'Agentic workflows', icon: '✦', cx: 620, cy: 400, r: 15, color: '#eab308', strokeWidth: 1.5, delay: 'd2', label: 'Agents', desc: { fr: 'Skills, hooks, sous-agents, orchestration', en: 'Skills, hooks, subagents, orchestration' }, iconSize: 11 },
    // Leadership (green)
